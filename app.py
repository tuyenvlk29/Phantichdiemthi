...
# Đọc file HTML của bạn (đặt tên file chính xác là academic_dashboard.html)
html_content = load_html_file("academic_dashboard.html")
...
if html_content:
    ...
    st.error("Không tìm thấy file 'academic_dashboard.html'. Vui lòng kiểm tra lại thư mục dự án của bạn!")